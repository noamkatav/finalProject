...
public class colorPickerScreen extends JFrame {
	...
	public static String[] combolist = new String[] {
			"easy",
			"hard"
	};
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource().equals(combo)) {
				if(combo.getSelectedIndex() == 0) {
					startingScreen.isHardLevel =false;
				}
				else
				{
					startingScreen.isHardLevel = true;
				}
			}
			...
			if(e.getSource().equals(launchGame))
			{
				...
				if(z==null)
				{
					 JOptionPane.showMessageDialog(null, startingScreen.isHardLevel);
	...
	public colorPickerScreen()//constructor
	{
		...
		this.combo = new JComboBox(this.combolist);
