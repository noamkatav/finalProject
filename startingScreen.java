...
public class startingScreen extends JFrame{
	public static colorPickerScreen m;
...
;		
		...
		ActionListener actionListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if((e.getSource().equals(tutorial))||(e.getSource().equals(gototutorial)))
				{
					...
					mainGameScreen tutorialGameScreen = new mainGameScreen(Color.RED,Color.BLUE,Color.BLACK,Color.WHITE);
				...
				if(e.getSource().equals(play))
				{
					mainframe.dispose();
					 ...
					 colorPickerScreen m = new colorPickerScreen();
				}
	...
	public static void main(String[] args) {
		...
		startingScreen x = new startingScreen();
